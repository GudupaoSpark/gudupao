import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, unref, ref, computed, defineComponent, h, Fragment, createVNode, Text, onScopeDispose, watch, toValue, useSlots, mergeProps, useSSRContext, resolveComponent, withCtx, createTextVNode, toDisplayString as toDisplayString$1, provide, Suspense, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { h as createHooks, i as getContext, c as createError$1, t as toRouteMatcher, k as createRouter, s as sanitizeStatusCode, l as executeAsync, m as getRequestHeaders, n as getRequestHeader, o as setCookie, p as getCookie, q as deleteCookie } from '../nitro/nitro.mjs';
...
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrRenderComponent, ssrRenderStyle, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
import { p as publicAssetsURL, u as useHead$1, h as headSymbol } from '../routes/renderer.mjs';
...
const unhead_lN6w9mmgiHo6VylqxuFXuzYS99kAesQJs_52jSAJihQ = defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_ZCWtc6YF7bpX0_dVxhFaLHsUC__xZ_2r__KqTCbOrRM = defineNuxtPlugin({
...
const localeLoaders = {
  "en-us": [
    {
      key: "locale_en_45us_46json_09c99c3b",
      load: () => import(
        './en-us.json.mjs'
        /* webpackChunkName: "locale_en_45us_46json_09c99c3b" */
      ),
      cache: true
    }
  ],
  "zh-cn": [
    {
      key: "locale_zh_45cn_46json_55058d31",
      load: () => import(
        './zh-cn.json.mjs'
        /* webpackChunkName: "locale_zh_45cn_46json_55058d31" */
      ),
      cache: true
    }
  ],
  "zh-hk": [
    {
      key: "locale_zh_45hk_46json_a23ec08e",
      load: () => import(
        './zh-hk.json.mjs'
        /* webpackChunkName: "locale_zh_45hk_46json_a23ec08e" */
      ),
      cache: true
    }
  ]
...
const normalizedLocales = [
  {
    ...
    files: [
      {
        path: "/home/runner/work/gudupao/gudupao/i18n/locales/en-us.json",
        cache: void 0
      }
    ]
  },
  {
    ...
    files: [
      {
        path: "/home/runner/work/gudupao/gudupao/i18n/locales/zh-cn.json",
        cache: void 0
      }
    ]
  },
  {
    ...
    files: [
      {
        path: "/home/runner/work/gudupao/gudupao/i18n/locales/zh-hk.json",
        cache: void 0
      }
    ]
  }
...
const switch_locale_path_ssr_9S7dfRTouVKlz0d3os_GWHD0D6Jcqvsejtpm6udlfXc = defineNuxtPlugin({
...
const route_locale_detect_ZLylsD3GeOw6FEw9RjZNOGRWhOQhJitHZEg1TqX1kbU = defineNuxtPlugin({
...
function createComposer(options = {}) {
  ...
  function numberParts(...args) {
    return wrapWithDeps((context) => Reflect.apply(number$1, null, [context, ...args]), () => parseNumberArgs(...args), "number format", (root) => root[NumberPartsSymbol](...args), NOOP_RETURN_ARRAY, (val) => isString$1(val) || isArray$1(val));
  }
...
const i18n_jGivfSwNLf4wM1F1PenDrV_dktr72SDsmBwqkRF91Z4 = defineNuxtPlugin({
  name: "i18n:plugin",
...
const motion_mBYrhWcmwavj5Fnd1TeAXbpm1Gri7_W_wzUhmB0Lk7c = defineNuxtPlugin(
  (nuxtApp) => {
...
const fortawesome_xxUpntyjJI2FS4UbUQ8I1O_5QNjzbXEhDzOAwJ2vmbU = defineNuxtPlugin((nuxtApp) => {
  library.add(fas, fab);
  nuxtApp.vueApp.component("font-awesome-icon", FontAwesomeIcon);
});

const ssg_detect_e2iIdw4Yiz_Ejyw46xAdZlX86afzK5shtUtXxQQD2zI = defineNuxtPlugin({
...
const plugins = [
  unhead_lN6w9mmgiHo6VylqxuFXuzYS99kAesQJs_52jSAJihQ,
  plugin,
  revive_payload_server_ZCWtc6YF7bpX0_dVxhFaLHsUC__xZ_2r__KqTCbOrRM,
  ...
  motion_mBYrhWcmwavj5Fnd1TeAXbpm1Gri7_W_wzUhmB0Lk7c,
  fortawesome_xxUpntyjJI2FS4UbUQ8I1O_5QNjzbXEhDzOAwJ2vmbU,
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(isLoading)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "loading-overlay" }, _attrs))} data-v-f3105022><img${ssrRenderAttr("src", _imports_0$1)} alt="Gudupao Logo" class="loading-logo" data-v-f3105022></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-f3105022"]]);
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "language-switcher" }, _attrs))} data-v-9216782e><div class="current-language" data-v-9216782e>${ssrInterpolate(unref(currentLocaleName))} <span class="${ssrRenderClass([{ "open": unref(isOpen) }, "dropdown-icon"])}" data-v-9216782e>▼</span></div>`);
      if (unref(isOpen)) {
        _push(`<div class="language-dropdown" data-v-9216782e><!--[-->`);
        ssrRenderList(unref(availableLocales), (locale2) => {
          _push(`<div class="language-option" data-v-9216782e>${ssrInterpolate(locale2.name)}</div>`);
        });
        _push(`<!--]--></div>`);
      } else {
        _push(`<!---->`);
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-9216782e"]]);
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "theme-switcher" }, _attrs))} data-v-8f9e89b7><button class="theme-toggle-btn" data-v-8f9e89b7>`);
      if (unref(isDarkTheme)) {
        _push(`<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-8f9e89b7><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" data-v-8f9e89b7></path></svg>`);
      } else {
        _push(`<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-8f9e89b7><circle cx="12" cy="12" r="5" data-v-8f9e89b7></circle><line x1="12" y1="1" x2="12" y2="3" data-v-8f9e89b7></line><line x1="12" y1="21" x2="12" y2="23" data-v-8f9e89b7></line><line x1="4.22" y1="4.22" x2="5.64" y2="5.64" data-v-8f9e89b7></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78" data-v-8f9e89b7></line><line x1="1" y1="12" x2="3" y2="12" data-v-8f9e89b7></line><line x1="21" y1="12" x2="23" y2="12" data-v-8f9e89b7></line><line x1="4.22" y1="19.78" x2="5.64" y2="18.36" data-v-8f9e89b7></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22" data-v-8f9e89b7></line></svg>`);
      }
      _push(`</button></div>`);
    };
  }
...
const ThemeSwitcher = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-8f9e89b7"]]);
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "site-header" }, _attrs))} data-v-eda200aa><div class="container" data-v-eda200aa><div class="logo" data-v-eda200aa>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} height="50" data-v-eda200aa${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`</div><div class="hamburger-menu" data-v-eda200aa><div class="${ssrRenderClass([{ "bar-1": unref(isMenuOpen) }, "bar"])}" data-v-eda200aa></div><div class="${ssrRenderClass([{ "bar-2": unref(isMenuOpen) }, "bar"])}" data-v-eda200aa></div><div class="${ssrRenderClass([{ "bar-3": unref(isMenuOpen) }, "bar"])}" data-v-eda200aa></div></div><nav class="${ssrRenderClass([{ "active": unref(isMenuOpen) }, "main-nav"])}" data-v-eda200aa><ul data-v-eda200aa><li data-v-eda200aa>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("nav.home")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li><li data-v-eda200aa>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/about",
        onClick: closeMenu,
        "active-class": "active-link"
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("nav.about")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("nav.projects"))}`);
          } else {
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("nav.projects")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString$1(_ctx.$t("nav.contact")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li><li class="language-menu-item" data-v-eda200aa>`);
      _push(ssrRenderComponent(_component_LanguageSwitcher, null, null, _parent));
      _push(`</li><li class="theme-menu-item" data-v-eda200aa>`);
      _push(ssrRenderComponent(ThemeSwitcher, null, null, _parent));
      _push(`</li></ul></nav><div class="header-right desktop-only" data-v-eda200aa>`);
      _push(ssrRenderComponent(_component_LanguageSwitcher, null, null, _parent));
      _push(ssrRenderComponent(ThemeSwitcher, null, null, _parent));
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-eda200aa"]]);
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))} data-v-05a392bf><div class="container" data-v-05a392bf><div class="footer-content" data-v-05a392bf><div class="footer-section" data-v-05a392bf>`);
      _push(ssrRenderComponent(_component_router_link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Gudupao Logo" class="logo-img" data-v-05a392bf${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<p class="company-desc" data-v-05a392bf>Pick up your own torch and light up your own future!</p><div class="social-links" data-v-05a392bf><a href="https://space.bilibili.com/1016857888" target="_blank" class="social-link" title="Bilibili" data-v-05a392bf><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="social-icon" data-v-05a392bf><path d="M17.813 4.653h.854c1.51.054 2.769.578 3.773 1.574 1.004.995 1.524 2.249 1.56 3.76v7.36c-.036 1.51-.556 2.769-1.56 3.773s-2.262 1.524-3.773 1.56H5.333c-1.51-.036-2.769-.556-3.773-1.56S.036 18.858 0 17.347v-7.36c.036-1.511.556-2.765 1.56-3.76 1.004-.996 2.262-1.52 3.773-1.574h.774l-1.174-1.12a1.234 1.234 0 0 1-.373-.906c0-.356.124-.658.373-.907l.027-.027c.267-.249.573-.373.92-.373.347 0 .653.124.92.373L9.653 4.44c.071.071.134.142.187.213h4.267a.836.836 0 0 1 .16-.213l2.853-2.747c.267-.249.573-.373.92-.373.347 0 .662.151.929.4.267.249.391.551.391.907 0 .355-.124.657-.373.906zM5.333 7.24c-.746.018-1.373.276-1.88.773-.506.498-.769 1.13-.786 1.894v7.52c.017.764.28 1.395.786 1.893.507.498 1.134.756 1.88.773h13.334c.746-.017 1.373-.275 1.88-.773.506-.498.769-1.129.786-1.893v-7.52c-.017-.765-.28-1.396-.786-1.894-.507-.497-1.134-.755-1.88-.773zM8 11.107c.373 0 .684.124.933.373.25.249.383.569.4.96v1.173c-.017.391-.15.711-.4.96-.249.25-.56.374-.933.374s-.684-.125-.933-.374c-.25-.249-.383-.569-.4-.96V12.44c0-.373.129-.689.386-.947.258-.257.574-.386.947-.386zm8 0c.373 0 .684.124.933.373.25.249.383.569.4.96v1.173c-.017.391-.15.711-.4.96-.249.25-.56.374-.933.374s-.684-.125-.933-.374c-.25-.249-.383-.569-.4-.96V12.44c.017-.391.15-.711.4-.96.249-.249.56-.373.933-.373Z" data-v-05a392bf></path></svg></a><a href="https://qm.qq.com/q/B3vKejsGBi" target="_blank" class="social-link" title="QQ" data-v-05a392bf><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="social-icon" data-v-05a392bf><path d="M12.003 2c-2.265 0-6.29 1.364-6.29 7.325v1.195S3.55 14.96 3.55 17.474c0 .665.17 1.025.281 1.025.114 0 .902-.484 1.748-2.072 0 0-.18 2.197 1.904 3.967 0 0-1.77.495-1.77 1.182 0 .686 4.078.43 6.29 0 2.239.425 6.287.687 6.287 0 0-.688-1.768-1.182-1.768-1.182 2.085-1.77 1.905-3.967 1.905-3.967.845 1.588 1.634 2.072 1.746 2.072.111 0 .283-.36.283-1.025 0-2.514-2.166-6.954-2.166-6.954V9.325C18.29 3.364 14.268 2 12.003 2Z" data-v-05a392bf></path></svg></a><a href="https://youtube.com/@GudupaoSpark" target="_blank" class="social-link" title="YouTube" data-v-05a392bf><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="social-icon" data-v-05a392bf><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" data-v-05a392bf></path></svg></a><a href="https://discord.gg/SC78fv3ZRF" target="_blank" class="social-link" title="Discord" data-v-05a392bf><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="social-icon" data-v-05a392bf><path d="M20.317 4.3698a19.7913 19.7913 0 00-4.8851-1.5152.0741.0741 0 00-.0785.0371c-.211.3753-.4447.8648-.6083 1.2495-1.8447-.2762-3.68-.2762-5.4868 0-.1636-.3933-.4058-.8742-.6177-1.2495a.077.077 0 00-.0785-.037 19.7363 19.7363 0 00-4.8852 1.515.0699.0699 0 00-.0321.0277C.5334 9.0458-.319 13.5799.0992 18.0578a.0824.0824 0 00.0312.0561c2.0528 1.5076 4.0413 2.4228 5.9929 3.0294a.0777.0777 0 00.0842-.0276c.4616-.6304.8731-1.2952 1.226-1.9942a.076.076 0 00-.0416-.1057c-.6528-.2476-1.2743-.5495-1.8722-.8923a.077.077 0 01-.0076-.1277c.1258-.0943.2517-.1923.3718-.2914a.0743.0743 0 01.0776-.0105c3.9278 1.7933 8.18 1.7933 12.0614 0a.0739.0739 0 01.0785.0095c.1202.099.246.1981.3728.2924a.077.077 0 01-.0066.1276 12.2986 12.2986 0 01-1.873.8914.0766.0766 0 00-.0407.1067c.3604.698.7719 1.3628 1.225 1.9932a.076.076 0 00.0842.0286c1.961-.6067 3.9495-1.5219 6.0023-3.0294a.077.077 0 00.0313-.0552c.5004-5.177-.8382-9.6739-3.5485-13.6604a.061.061 0 00-.0312-.0286zM8.02 15.3312c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9555-2.4189 2.157-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.9555 2.4189-2.1569 2.4189zm7.9748 0c-1.1825 0-2.1569-1.0857-2.1569-2.419 0-1.3332.9554-2.4189 2.1569-2.4189 1.2108 0 2.1757 1.0952 2.1568 2.419 0 1.3332-.946 2.4189-2.1568 2.4189Z" data-v-05a392bf></path></svg></a><a href="https://x.com/GudupaoSpark" target="_blank" class="social-link" title="X" data-v-05a392bf><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="social-icon" data-v-05a392bf><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" data-v-05a392bf></path></svg></a><a href="https://github.com/GudupaoSpark" target="_blank" class="social-link" title="GitHub" data-v-05a392bf><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="social-icon" data-v-05a392bf><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" data-v-05a392bf></path></svg></a><a href="https://gudupao-status.hf.space/status/main" target="_blank" class="social-link" title="Uptime" data-v-05a392bf><svg class="social-icon" width="640" height="640" viewBox="0 0 640 640" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" data-v-05a392bf><g transform="matrix(1 0 0 1 320 320)" data-v-05a392bf><linearGradient id="S3" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1 0 0 1 -319.99875 -320.0001577393)" x1="259.78" y1="261.15" x2="463.85" y2="456.49" data-v-05a392bf><stop stop-color="#5CDD8B" data-v-05a392bf></stop><stop offset="1" stop-color="#86E6A9" data-v-05a392bf></stop></linearGradient><path style="${ssrRenderStyle({ "stroke": "rgb(242,242,242)", "stroke-opacity": "0.51", "stroke-width": "200", "stroke-dasharray": "none", "stroke-linecap": "butt", "stroke-dashoffset": "0", "stroke-linejoin": "miter", "stroke-miterlimit": "4", "fill": "url(#S3)", "fill-rule": "nonzero", "opacity": "1" })}" transform=" translate(0, 0)" d="M 170.40125 -84.36016 C 224.09125 38.37984 224.09125 115.33984 170.40125 146.49984 C 89.85125000000001 193.23984000000002 -120.03875 207.48984000000002 -180.45875 135.63984 C -220.73875 87.73983999999999 -220.73875 14.399839999999998 -180.45875 -84.36016000000001 C -139.49875 -151.82016 -81.28875000000001 -185.55016 -5.828750000000014 -185.55016 C 69.64124999999999 -185.55016 128.38125 -151.82016000000002 170.40124999999998 -84.36016000000001 z" stroke-linecap="round" data-v-05a392bf></path></g></svg></a></div></div><div class="footer-section" data-v-05a392bf><h3 class="footer-title" data-v-05a392bf>${ssrInterpolate(_ctx.$t("footer.quickLinks"))}</h3><ul class="footer-links" data-v-05a392bf><li data-v-05a392bf>`);
      ...
      _push(`</li></ul></div><div class="footer-section" data-v-05a392bf><h3 class="footer-title" data-v-05a392bf>${ssrInterpolate(_ctx.$t("footer.Friendly-links"))}</h3><ul class="footer-links" data-v-05a392bf><li data-v-05a392bf><a href="https://open.gudupao.top" target="_blank" data-v-05a392bf>GOS</a></li><li data-v-05a392bf><a href="https://haaaash.gudupao.top/" target="_blank" data-v-05a392bf>haaaash</a></li><li data-v-05a392bf><a href="https://code-fix.gudupao.top" target="_blank" data-v-05a392bf>CodeFix</a></li><li data-v-05a392bf><a href="https://1nk.ltd" target="_blank" data-v-05a392bf>咸鱼短链</a></li></ul></div><div class="footer-section" data-v-05a392bf><h3 class="footer-title" data-v-05a392bf>${ssrInterpolate(_ctx.$t("footer.contactUs"))}</h3><ul class="footer-contact" data-v-05a392bf><li data-v-05a392bf><svg class="contact-icon" viewBox="0 0 24 24" data-v-05a392bf><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" data-v-05a392bf></path></svg><a href="mailto:officialt@gudupao.top" data-v-05a392bf>official@gudupao.top</a></li><li data-v-05a392bf><svg class="contact-icon" viewBox="0 0 24 24" data-v-05a392bf><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" data-v-05a392bf></path></svg><span data-v-05a392bf>${ssrInterpolate(_ctx.$t("footer.address"))}</span></li></ul></div></div><div class="divider" data-v-05a392bf></div><div class="copyright" data-v-05a392bf><p data-v-05a392bf>© ${ssrInterpolate(unref(currentYear))} Gudupao Spark Inc. ${ssrInterpolate(_ctx.$t("footer.rights"))}</p></div></div></footer>`);
    };
  }
};
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-05a392bf"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LoadingOverlay = __nuxt_component_0$1;
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.16.0_@parcel+watcher@2.5.1_@types+node@22.13.10_db0@0.3.1_eslint@9.22.0_jiti@2.4_1a9f514ffdd3c7e453930549b9c3c241/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.16.0_@parcel+watcher@2.5.1_@types+node@22.13.10_db0@0.3.1_eslint@9.22.0_jiti@2.4_1a9f514ffdd3c7e453930549b9c3c241/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, __nuxt_component_0 as a, useI18n as b, _imports_0$1 as c, server as s, useHead as u };
